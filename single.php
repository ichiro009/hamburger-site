    ...
    <main class="l-main">
      ...
      <section class="p-content c-inner--common">
        ...
        <div class="p-title-area">
          ...
          <h3 class="c-title--middle">見出しh3</h3>
        ...
        <article class="p-gallery">
          <img class="p-gallery__top" src="./imges/common/sp/top-burger-sp.png" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
          <ul class="p-gallery__pair">
            <li class="p-gallery__pair__item">
              <figure class="p-media">
                <img class="p-media__img" src="./imges/common/sp/pair-burger-sp.png" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
                <figcaption class="p-media__caption">
          ...
          <img class="p-gallery__middle" src="./imges/common/sp/middle-burger-sp.png" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
          <div class="p-gallery__bottom">
            <img class="p-gallery__bottom-img" src="./imges/common/sp/loop-burger-sp.jpg" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
            <img class="p-gallery__bottom-img" src="./imges/common/sp/loop-burger-sp.jpg" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
            <img class="p-gallery__bottom-img" src="./imges/common/sp/loop-burger-sp.jpg" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
            <img class="p-gallery__bottom-img" src="./imges/common/sp/loop-burger-sp.jpg" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
            <img class="p-gallery__bottom-img" src="./imges/common/sp/loop-burger-sp.jpg" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
        ...
        <div class="p-lists">
          <ol class="p-lists__list">
            ...
            <li class="p-lists__item">
              リストリストリスト
              <ol class="p-sub-list">
                <li class="p-sub-list__item">リスト2リスト2リスト2</li>
                <li class="p-sub-list__item">リスト2リスト2リスト2</li>
              </ol>
            </li>
          </ol>
          <ol class="p-lists__list">
            <li class="p-lists__item">リストリストリスト
            </li>
            <li class="p-lists__item">リストリストリスト
            </li>
          </ol>
          <ul class="p-lists__list"">
            <li class=" p-lists__item">リストリストリスト</li>
            <li class="p-lists__item">
              リストリストリスト
              <ul class="p-sub-list">
                <li class="p-sub-list__item">リスト2リスト2リスト2
                </li>
                <li class="p-sub-list__item">リスト2リスト2リスト2
                </li>
              </ul>
