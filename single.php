...
<main class="l-main">
  ...
  <section class="p-content c-inner--common">
    ...
    <article class="p-gallery">
      ...
      <ul class="p-gallery__pair">
        <li class="p-gallery__pair__item">
          <figure class="p-media">
            <img class="p-media__img" src="<?php echo get_theme_file_uri(); ?>./imges/common/sp/pair-burger-sp.png" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
      ...
      <img class="p-gallery__middle" src="<?php echo get_theme_file_uri(); ?>./imges/common/sp/middle-burger-sp.png" alt="ボリューミーなハンバーガーと皮つきポテトの画像">
